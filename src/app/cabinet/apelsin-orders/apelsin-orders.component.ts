...
@Component({
  selector: 'app-apelsin-orders',
  templateUrl: './apelsin-orders.component.html',
  styleUrls: ['./apelsin-orders.component.scss']
})

export class ApelsinOrdersComponent implements OnInit {
  public orders: any = [
    {
